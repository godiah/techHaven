        ...
        <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/5 lg:block">
                    <div
                        class="p-4 mb-5 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-900 dark:border-gray-800">
                        <div class="flex justify-center mb-2">
                            <img src="{{ url('storage', $brand->image) }}" alt="{{ $brand->slug }}"
                                class="object-contain  w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24">
                        </div>
                        <div
                            class="font-heading -mt-7 text-lg font-bold py-2 flex items-center text-secondary before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6">
                            Categories</div>
                ...
                <div class="w-full px-3 lg:w-4/5">
                    <div class="font-heading px-3 mb-4 flex items-center justify-between">
                        <h2 class="text-xl font-semibold tracking-wide text-gray-900 dark:text-white sm:text-2xl">
                            {{ $brand->name }}
                        </h2>
                        <!-- Sort By Filter -->
