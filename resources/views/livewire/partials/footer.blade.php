<footer class="bg-white shadow-md dark:bg-gray-900">
    <div class="mx-auto max-w-screen-xl  pt-14 pb-4  lg:pt-20">
        <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-3">
                ...
                <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                    <li>
                        <a href="#" rel="noreferrer" target="_blank"
                            class="text-accent transition hover:text-accent/75">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                <div class="text-center sm:text-left">
                    <p class="text-base font-heading font-medium text-secondary dark:text-white">About Us</p>
                ...
                <div class="text-center sm:text-left">
                    <p class="text-base font-heading font-medium text-secondary dark:text-white">Our Services</p>
                ...
                <div class="text-center sm:text-left">
                    <p class="text-base font-heading font-medium text-secondary dark:text-white">Helpful Links</p>
                ...
                <div class="text-center sm:text-center">
                    <p class="text-base font-heading font-medium text-secondary dark:text-white">Contact Us</p>

                    <ul class="font-body mt-8 space-y-4 text-sm">
                        <li>
                            <a class="w-full flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end"
                                href="#">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="size-5 shrink-0 text-accent dark:text-white" fill="none"
                        ...
                        <li
                            class="w-full flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="size-5 shrink-0 text-accent dark:text-white" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="font-body mt-12 border-t border-gray-300 pt-6 dark:border-gray-800">
            <div class="text-center sm:flex sm:justify-between sm:text-left">
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <a class="inline-block text-accent underline transition hover:text-accent/75" href="#">
                        Terms & Conditions
                    </a>
